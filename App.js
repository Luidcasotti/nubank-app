...
const Header = () => (
  <View style={styles.cabecalho}>
    ...
    <View style={styles.boxTextUsuario}>
      <Text style={styles.textUsuario}>Olá, Manuela nunes leal</Text>
...
export default function App() {
  ...
  const buttons = [
    ...
    { icon: require('./assets/img/depositar.png'), label: 'Recarga de celular', direction: 'right' },
    { icon: require('./assets/img/emprestimo.png'), label: 'Pegar emprestado', direction: 'left' },
  ];
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.saldoContainer}>
          ...
          <Text style={styles.saldoAmount}>R$ 8.245,00</Text>
        </View>
        ...
        <Card title="Cashback e Benefícios" amount="R$78,77" />
